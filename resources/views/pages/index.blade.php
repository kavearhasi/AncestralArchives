...
@section('content')
    <x-pages.banner pageTitle="Home" bannerImage="assets/images/building-6536320_1920.jpg">
        <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a
                    href="{{ url('/home') }}">Home</a></span></p>
        <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">A people without the knowledge of their past history, origin and culture is like a tree without roots.</h1>
