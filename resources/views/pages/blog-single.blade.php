...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.blade.php">Welfare</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="causes.blade.php" class="nav-link">Causes</a></li>
          <li class="nav-item"><a href="help.blade.php" class="nav-link">Donate</a></li>
          <li class="nav-item active"><a href="blog.blade.php" class="nav-link">Blog</a></li>
          <li class="nav-item"><a href="gallery.blade.php" class="nav-link">Gallery</a></li>
          <li class="nav-item"><a href="event.blade.php" class="nav-link">Events</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
             <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="index.blade.php">Home</a></span> <span class="mr-2"><a href="blog.blade.php">Blog</a></span> <span>Blog Details</span></p>
